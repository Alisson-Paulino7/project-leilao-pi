    ...
    <div class="document">
        <table cellspacing="0" cellpadding="0">
            <tr class="topLine">
                ...
                <td class="sideBorders center"><span style="font-size:24px;font-weight:bold;">999-9</span></td>
                <td class="boletoNumber center"><span>0000.0000 0000.0000 0000.0000 0 00000000000</span></td>
            </tr>
        </table>
        <table cellspacing="0" cellpadding="0" border="1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                    <p class="content center">129,90</p>
                </td>
                <td width="30%">
                    <span class="title">(=) Valor do Documento</span>
                    <br/>
                    <br/>
                    <p class="content right">129,90</p>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="7">
                    <table border="0" style="border:none">
                        <tr>
                            ...
                            <td><span class="text"><b>CNPJ/CPF: </b> 123.123.123-12</span></td>
                        </tr>
                        <tr>
